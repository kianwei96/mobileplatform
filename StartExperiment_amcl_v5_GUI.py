...
def get_xy_loc(msg):
        ...
        size_x_map = 3328 #in pixel 1728 no difference when changed 3328 //ori both 1088
        size_y_map = 1952 #in pixel 1156 no difference when changed 1952
        locs_x_map_origin = -11.4 #in meter //ori -12.2  //map7.yaml parameters (-31.4)
        locs_y_map_origin = -16.2 #in meter //ori -13.8  //map7.yaml parameters (-23.4) corrected -25.4
...
def SaveTrialParameters(appendInfo):
    appendFile = open("/home/sinapse/Desktop/MonkeyGUI-master/RewardData/05042019/2_Chimpian/ExperimentParameters.csv", "a")
